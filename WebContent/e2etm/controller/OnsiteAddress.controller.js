...
.controller(
	...
	//					 Send OData Create request
			...
			/////###################### UCD1KOR 2 Dec 2019 ###################//////
			////########## PE-Payroll team and Employee can see the onsite address screen they can go back the previous screen #####/////
				else{
					window.history.go(-1);
				}
			},			
			...
			onEditPress:function(oEvent) {
				var oData = this.getView().getModel("onsiteAddress").getData();
				//Change icon & text
				if (oData.view.editable == true ) { //interchange of if-else stmts uml6kor_upgrade 28/11/2019
