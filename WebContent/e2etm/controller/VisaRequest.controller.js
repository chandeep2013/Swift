	...
	onValueHelpRequest : function(evt) {
		...
		var oValueHelpDialog = new sap.ui.comp.valuehelpdialog.ValueHelpDialog({
			...
			ok : function(oControlEvent) {
				...
				if (oControl.getId().indexOf("fundId") != -1) { 
					
			//////////////################# Fund change functionality ###############//////////////
			/////////////######### UCD1KOR 4th Dec 2019 Start##################///////////////////	
					...
					VisaPlanThis.getView().byId("costCenterId-__clone" + costCenterCloneNum).setEditable(false);
					VisaPlanThis.getView().byId("wbsId-__clone" + wbsCloneNum).setEditable(false);

					if (sKey == "F01") {
					            VisaPlanThis.getView().byId("wbsId-__clone" + wbsCloneNum).setEditable(false);
					            VisaPlanThis.getView().byId("costCenterId-__clone" + costCenterCloneNum).setEditable(true)
					     } else if (sKey == "F02" || sKey == "F03" || sKey == "F04") {
					            VisaPlanThis.getView().byId("wbsId-__clone" + wbsCloneNum).setEditable(true);
					     } else {
					            VisaPlanThis.getView().byId("costCenterId-__clone" + costCenterCloneNum).setEditable(true);
					            VisaPlanThis.getView().byId("wbsId-__clone" + wbsCloneNum).setEditable(true);
					     }
		 ////////////////######### UCD1KOR 4th Dec 2019 End##################////////////////////	
		...
		//dye5kor_UgradeFix_06.11.2019
		oValueHelpDialog.theTable = oValueHelpDialog.getTable();
		//dye5kor_UpgradeFix_06.11.2019
		...
		if (oControl.getId().indexOf("customerId") != -1) { // Customer
			...
			//dye5kor_UpgradeIssuesFix_06.11.2019
			var sControlId;
			if(oControl.sId.indexOf("fund") != -1){
				sControlId = "col1";
