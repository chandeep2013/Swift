...
*/
	...
	onRouteMatched:function(evt){
		...
		//25 Feb 2020 UCD1KOR All Countries item added
		if(country[1].MOLGA != "all"){
			var allcountries = {MOLGA: "all", LTEXT: "All Countries"}
			country.splice(1, 0, allcountries );
		}
		//25 Feb 2020 UCD1KOR end
		var cntryModel = new sap.ui.model.json.JSONModel();
		cntryModel.setData(country);
		//25 Feb 2020 UCD1KOR increase country model size
		cntryModel.setSizeLimit(country.length);
