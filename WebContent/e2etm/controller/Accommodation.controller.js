...
//					var sActive = this.getView().getModel("profile").getData().currentRole;
					...
					this.getView().byId("btnBookRooms").setVisible(true); // ucd1kor 22/05/2021 added 
...
//					varsDEPRequest = oRequest.ZZ_TRV_REQ;
					...
					var sTravelRequest = oRequest.ZZ_TRV_REQ;
					 try{
	                    	var endDate = oRequest.ZZ_DEP_ENDATE;
	                    	var endDateObj = new Date(endDate.substring(0,4),endDate.substring(4,6)-1,endDate.substring(6,8));
					...
					///// ucd1kor 23/05/2021 created blow model
					var oModel = new sap.ui.model.json.JSONModel();		
		            oModel.setProperty("/asgGroup","");
