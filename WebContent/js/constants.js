...
var oStaticRoutes = {
	...
	"setlusetlreport": {
		"pattern": "Settled/Unsettled Report/role/{role}",
	...
	//uea6kor_7.12.2020 settlement report
	"SettlementReport": {
		"pattern": "SettlementReport",
		"name": "SettlementReport",
		"view": "SettlementReport",
		"viewType": "XML",
		"viewPath": "sap.ui.project.e2etm.view",
		"targetControl": "appID",
		"targetAggregation": "pages"
	...
	"personaltripreport": {
		"pattern": "PersonalTravelReport/role/{role}",
		"name": "personaltripreport",
		"view": "Personal_Travel_Report",
		"viewType": "XML",
		"viewPath": "sap.ui.project.e2etm.view",
		"targetControl": "appID",
		"targetAggregation": "pages"
	...
	"moretrstreport": {
		...
		"subroutes": [{
			...
			"pattern": "setlusetlSplitreport/role/{role}",
			"name": "setlusetlSplitreport",
			"view": "SetlUsetlReport",
			"viewType": "XML",
			"viewPath": "sap.ui.project.e2etm.view",
			"clearTarget": true,
		...
		{
			"pattern": "InlandTravel_Digital",
			"name": "InlandTravel_Digital",
			"view": "InlandTravel_Digital",
			"viewType": "XML",
			"viewPath": "sap.ui.project.e2etm.view",
			"clearTarget": true,
			"targetControl": "splitapp",
		...
		///// UCD1KOR Nov 20,2020 MIS INsurance Report Added /////
		{
			"pattern": "MISInsuranceReportTR",
			"name": "MISInsuranceReportTR",
			"view": "MISInsuranceReport",
			"viewType": "XML",
			"viewPath": "sap.ui.project.e2etm.view",
			"clearTarget": true,
			"targetControl": "splitapp",
	...
	},/*UCD1KOR sub route added for travelsettlement above*/
	...
	"AccmTool": {
		...
		"subroutes": [{
				...
				"pattern": "ReservationOverview/Reservation/:pernr:/:reinr::?query:",
				"name": "reservation",
	...
	"businessTravelRequest": {
		"pattern": "Portal/TravelRequest/{reqId}/{ischange}",
		"name": "TravelRequest",
		"view": "TravelRequest",
		"viewType": "XML",
		"viewPath": "sap.ui.project.e2etm.view",
	...
	"RegistrationDetails": {
		"pattern": "RegistrationDetails/{reinr}/{pernr}/{ttype}:?query:",
	...
	"Repatriation": {
		"pattern": "Repatriation/{TpNo}/{EmpNo}:?query:",
		"name": "Repatriation",
		"view": "Repatriation",
		"viewType": "XML",
		"viewPath": "sap.ui.project.e2etm.view",
...
/////############# UCD1KOR NOV 2 Route for PEExposureReport ##################///////////////////
	"PEExposureReport": {
		"pattern": "PEExposureReport",
		"name": "PEExposureReport",
		"view": "PEExposureReport",
		"viewType": "XML",
		"viewPath": "sap.ui.project.e2etm.view",
		"targetControl": "appID",
		"targetAggregation": "pages"
...
/////############# UCD1KOR NOV 9 Route for InlandMISReport ##################///////////////////
	"InlandMISReport": {
		"pattern": "InlandMISReport",
		"name": "InlandMISReport",
		"view": "InlandMISReport",
		"viewType": "XML",
		"viewPath": "sap.ui.project.e2etm.view",
		"targetControl": "appID",
		"targetAggregation": "pages"
	},
/////############# UCD1KOR NOV 18 Route for MISInsuranceReport ##################///////////////////
	"MISInsuranceReport": {
		"pattern": "MISInsuranceReport",
		"name": "MISInsuranceReport",
		"view": "MISInsuranceReport",
		"viewType": "XML",
		"viewPath": "sap.ui.project.e2etm.view",
		"targetControl": "appID",
	...
	///############## added by UIK1KOR on 03/12/2020  for BusinessTravelReport #######################///// 
	"BusinessTravelReport": {
		"pattern": "BusinessTravelReport",
		"name": "BusinessTravelReport",
		"view": "BusinessTravelReport",
		"viewType": "XML",
		"viewPath": "sap.ui.project.e2etm.view",
		"targetControl": "appID",
		"targetAggregation": "pages"
...
//////// ################ 07 Apr 2020 UCD1KOR Repatriation,HRBPDashboard routes added ##################//////////////
//-------------------------------------tinhtd 09/2018
