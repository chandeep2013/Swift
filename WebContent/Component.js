...
//				var batchOperation26 = oDataModel.createBatchOperation("CurrencyExchangeSet", "GET");
				...
				var batchOperation28 = oDataModel.createBatchOperation("Feedback_HdrSet", "GET"); //fetch ratings uml6kor 6/5/2021 RBEIITAPPPIPELINE-1350 (Feedback form)
				//var batchOperation29 = oDataModel.createBatchOperation("GetConstant?CONST='AUTO_POST'&SELPAR='ADVC'&$format=json", "GET"); /// ucd1kor 24/06/2021
				oDataModel.addBatchReadOperations([batchOperation0,batchOperation1,batchOperation2,batchOperation3,
				                                   ...
				                                   batchOperation20,batchOperation21,batchOperation22,batchOperation23,
				                                   batchOperation24,batchOperation25,batchOperation26,batchOperation27,batchOperation28]);
				oDataModel.submitBatch(function(oResult) {
					...
					globalData.DepTravelType = oResult.__batchResponses[24].data.results; // New Policy changes by UEA6KOR_29.05.2019	
...
//					globalData.CurrExchange = oResult.__batchResponses[26].data.results; //Currency Exchange by MYU1KOR
					...
					globalData.ratings = oResult.__batchResponses[28].data.results;  //fetch ratings uml6kor 6/5/2021 RBEIITAPPPIPELINE-1350 (Feedback form)
					
					//globalData.autoPostDate = oResult.__batchResponses[29].data.GetConstant.VALUE;  //fetch auto posting date ucd1kor
					...
					try {
						//UCD1KOR Added below retirment date 29 Jan 2021
						aData.employeeDetail.RetirementDate = oResult.__batchResponses[6].data.ZZ_DEP_RDAT;
